...
export const EDIT_TAG_URL = BACKEND_URL + '/tag/modify';
...
export const ADD_TRANSLATION_FOR_LANGUAGE_URL = BACKEND_URL + '/alerts/add';
export const CHANGE_TRANSLATION_FOR_LANGUAGE_URL = BACKEND_URL + '/alerts/edit';
export const GET_ALL_TRANSLATIONS_URL = BACKEND_URL + '/original/alerts/findAll';
export const CREATE_TRANSLATION_URL = BACKEND_URL + '/original/alerts/add';
export const EDIT_TRANSLATION_URL = BACKEND_URL + '/original/alerts/edit';
export const DELETE_TRANSLATION_URL = BACKEND_URL + '/original/alerts/remove';
export const GET_TRANSLATION_BY_ID_URL = BACKEND_URL + '/alerts/find';
export const GET_MAIN_TRANSLATION_BY_ID_URL = BACKEND_URL + '/original/alerts/find';
